    ...
    <body>
        ...
        <div>
            ...
            <h3>Course section</h3>
             <a href="${pageContext.servletContext.contextPath}/view/addcoursecontent">Add Course Content</a>
            <c:if test="${sessionScope.$LoggedInUserObj.userRole == 'LECTURER'}">
                <a href="${pageContext.servletContext.contextPath}/view/addcoursemodule">Add Course Module</a>
            </c:if>
            -->
        </div>
        <div>
