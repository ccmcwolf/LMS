<%-- 
    Document   : addModule
    Created on : Dec 18, 2016, 10:53:57 PM
...
<html>
    ...
    <body>
        ...
        <br>
        <br>
   <!--   <form action="${pageContext.servletContext.contextPath}/course/moduleadd" method="POST">
            Module name: <input type="text" placeholder="Module name" required="true" name="moduleName"/><br>
            Module description: <input type="textarea" placeholder="Module description" required="true" name="moduleDescription"/><br>
            Module path: <input type="text" placeholder="Module path" required="true" name="modulePath"/><br>
            Course ID : 
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Add Module - LMS</h1>
                            ...
                            <div id="imPageRowContent_2" class="imContentDataContainer">
                                <div id="imCell_1" class="" > 
                                    ...
                                    <div id="imCellStyle_1"  data-responsive-sequence-number="1">
                                        <form id="imObjectForm_1" action="${pageContext.servletContext.contextPath}/course/moduleadd" method="post" enctype="multipart/form-data">
                                            <fieldset class="first">
                                                <div>
                                                    ...
                                                    <div id="imObjectForm_1_1_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_1_label" for="imObjectForm_1_1">Lecture*</label><br /><div id="imObjectForm_1_1_field">
                                                            <select class="mandatory " id="imObjectForm_1_1" name="lecturerID">
                                                                <c:forEach items="${requestScope.$lecture}" var="lecture">
                                                                    <option value="${$lecture.$lectureId}">${$lecture.$lectureId}</option>
                                                                </c:forEach>
                                                            </select></div>
                                                    </div>
                                                </div>
