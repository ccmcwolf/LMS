<%-- 
    ...
    Created on : Dec 26, 2016, 1:24:22 PM
    Author     : yosha
--%>
    ...
    <body>
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Search Lecturer  LMS</h1>
                ...
                <div id="imContent">
                    ...
                    <div id="imPgMnContainer"><div id="imPgMn">
                            <ul class="auto">
                                ...
                                <li id="imPgMnNode49" class="imPgMnFirst imPgMnCurrent">
                    ...
                    <div class="imContentDataContainer">
                        <h2 id="imPgTitle">Search Lecturer</h2>
                                    ...
                                    <div id="imCell_2" class="" > 
                                        ...
                                        <div id="imCellStyle_2"  data-responsive-sequence-number="1">
                                            <div id="imObjectSearch_49_02">
                                                <form id="imObjectSearch_49_02_form" action="${pageContext.servletContext.contextPath}/lecturer/search" method="post">
                                                    <fieldset>
                                                        <input type="text" id="imObjectSearch_49_02_field" name="lid" value="" />
                                    ...
                                    <c:if test="${requestScope.lec.lecturerName != 'no_lec'}">
                                        <ul>
                                            ...
                                            <table style="padding: 50px">
                                                <tr>
                                                    <th style="padding: 20px"> Lecture : </th>
                                                    <td style="padding: 20px"> <c:out value="${requestScope.lec.lecturerName}"/> </td>
                                                </tr>
                                                <tr>
                                                    <th style="padding: 20px"> DOB     : </th>
                                                    <td style="padding: 20px"> <c:out value="${requestScope.lec.dob}"/> </td>
                                                </tr>
                                                <tr>
                                                    <th style="padding: 20px"> Address : </th>
                                                    <td style="padding: 20px"> <c:out value="${requestScope.lec.address}"/> </td>
                                                </tr> 
                                            </table>                                   
                                        </ul>
                                    </c:if>
