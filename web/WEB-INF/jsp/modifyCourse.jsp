<%-- 
    ...
    Created on : Dec 26, 2016, 10:38:26 AM
    Author     : User
--%>
      ...
      <div id="imHeaderBg"></div>
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Modify Course - LMS</h1>
            ...
            <div id="imContentContainer">
                ...
                <div id="imContent">
                    ...
                    <div class="imContentDataContainer">
                        <h2 id="imPgTitle">Modify Course</h2>
                                                ...
                                                <fieldset class="first">
                                                    <div>
                                                        ...
                                                        <div id="imObjectForm_1_2_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_2_label" for="imObjectForm_1_2">Course Name*</label><br /><div id="imObjectForm_1_2_field">
                                                         ...
                                                         <div id="imObjectForm_1_2_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_2_label" for="imObjectForm_1_2">Course Duration -In Months*</label><br /><div id="imObjectForm_1_2_field">
                                                                <input type="text" placeholder="Course Duration - In Months" required="true" name="courseDuration" class="mandatory " id="imObjectForm_1_2"/></div>
                                                        </div>
