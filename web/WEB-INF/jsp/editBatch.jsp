<%-- 
    Document   : editBatch
    Created on : Dec 26editBatch, 2016, 11:26:47 AM
    Author     : User
--%>
    ...
    <body>
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Edit Batch - LMS</h1>
                ...
                <div id="imContent">
                    ...
                    <div id="imPgMnContainer"><div id="imPgMn">
                            <ul class="auto">
                                ...
                                <li id="imPgMnNode46" class="imPgMnLast imPgMnCurrent">
                            ...
                            <div id="imPageRowContent_2" class="imContentDataContainer">
                                <div id="imCell_1" class="" > 
                                    ...
                                    <div id="imCellStyle_1"  data-responsive-sequence-number="1">
                                        <form id="imObjectForm_1" action="${pageContext.servletContext.contextPath}/batch/edit" method="POST" enctype="multipart/form-data">
                                            <fieldset class="first">
                                                <div>
                                                    ...
                                                    <div id="imObjectForm_1_3_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_3_label" for="imObjectForm_1_3">Start*</label><br /><div id="imObjectForm_1_3_field">
                                                            <input type="date" placeholder="Start date" required="true" name="startDate" data-showicon="true" data-format="[dd]/[mm]/[yyyy]" class="mandatory datepicker" id="imObjectForm_1_3" /><img id="imObjectForm_1_3_icon" class="imDatePickerIcon" src="res/date.gif"></div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <fieldset>
