<%-- 
    Document   : addExam
    Created on : Dec 22, 2016, 10:26:42 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        <h1>Add Exam</h1>
        <!--  Exam name : <input type="text" placeholder="Exam name" required="true" name="examName"/><br>
          No of question : <input type="text" placeholder="Username" required="true" name="noOfQuestions"/><br>
          Duration : <input type="text" placeholder="Username" required="true" name="duration"/><br>
          Module ID : 
          <select name="cid">
              <c:forEach items="${requestScope.$modules}" var="courses">
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Add Exam - LMS</h1>
            ...
            <div id="imContentContainer">
                ...
                <div id="imContent">
                    ...
                    <div id="imPgMnContainer"><div id="imPgMn">
                            <ul class="auto">
                                <li id="imPgMnNode27" class="imPgMnFirst imPgMnCurrent">
                                            ...
                                            <fieldset class="first">
                                                <div>
                                                    ...
                                                    <div id="imObjectForm_1_2_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_2_label" for="imObjectForm_1_2">Exam Name*</label><br /><div id="imObjectForm_1_2_field">
                                                            <input type="text" class="mandatory " id="imObjectForm_1_2" name="examName" /></div>
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <div id="imObjectForm_1_3_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_3_label" for="imObjectForm_1_3">Module ID*</label><br /><div id="imObjectForm_1_3_field">
                                                            <input type="text" class="mandatory " id="imObjectForm_1_3" name="moduleID" /></div>
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <div id="imObjectForm_1_4_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_4_label" for="imObjectForm_1_4">Duration in hours*</label><br /><div id="imObjectForm_1_4_field">
                                                            <input type="text" class="mandatory valNumber" id="imObjectForm_1_4" name="duration" /></div>
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <div id="imObjectForm_1_5_container" class="imObjectFormFieldContainer"><label id="imObjectForm_1_5_label" for="imObjectForm_1_5">Number of Questions*</label><br /><div id="imObjectForm_1_5_field">
                                                            <input type="text" class="mandatory valNumber" id="imObjectForm_1_5" name="noOfQuestions" /></div>
                                                    </div>
                                                    <br>
                                                    <br> 
                                                    <br>
