<%-- 
    Document   : examAnswer
    Created on : Dec 26, 2016, 1:25:37 PM
    Author     : User
--%>
    ...
    <body>
        ...
        <div id="imPage">
            ...
            <div id="imHeader">
                ...
                <h1 class="imHidden">Exam Answer - LMS</h1>
                ...
                <div id="imContent">
                    ...
                    <div id="imPgMnContainer"><div id="imPgMn">
                            <ul class="auto">
                                ...
                                <li id="imPgMnNode42" class="imPgMnFirst imPgMnCurrent">
                    ...
                    <div class="imContentDataContainer">
                        <h2 id="imPgTitle">Exam Answer</h2>
