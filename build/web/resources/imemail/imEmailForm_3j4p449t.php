...
if(substr(basename($_SERVER['PHP_SELF']), 0, 11) == "imEmailForm") {
	...
	$form = new ImForm();
	$form->setField('Lecturer Name', $_POST['imObjectForm_4_1'], '', false);
	$form->setField('NIC', $_POST['imObjectForm_4_2'], '', false);
	...
	$form->setField('username', $_POST['imObjectForm_4_6'], '', false);
	$form->setField('password', $_POST['imObjectForm_4_7'], '', false);
